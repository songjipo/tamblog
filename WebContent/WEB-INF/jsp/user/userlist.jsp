...
<body class="easyui-layout" style="visibility:hidden;" onkeydown="enterlogin();">
	<div region="center" border="false" title="用户列表">
    	<table id="grid"></table>
	</div>
		...
		<div id="toolbar" style="padding:2px 5px;">
        	<table>
				<tr>
					...
					<!-- <td><a href="" class="easyui-linkbutton" data-options="iconCls:'icon-cancel',plain:true" onclick="cleansearch();return false;">清空查询条件</a></td> -->
				</tr>
			</table>
    	</div>
