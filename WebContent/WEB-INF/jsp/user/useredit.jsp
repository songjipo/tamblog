	...
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;">
		...
		<input name="id" type="hidden" value="${tuser.id}">
			<table class="table-edit" width="80%" align="center">
					...
					<tr>
						<td>用户名称</td>
						<td><input type="text" data-options="validType:'stringCheck',required:true" name="username" class="easyui-validatebox" value="${tuser.username }"/></td>
					</tr>
					<tr>
						<td>手机</td>
						<td>
						...
						<input type="text" data-options="validType:'telephone',required:true" name="phone" class="easyui-validatebox" value="${tuser.phone }"/></td>
					</tr>
					<tr>
	           		<td>选择角色:</td>
