...
<body class="easyui-layout" style="visibility:hidden;" onkeydown="enterlogin();">
	<div region="center" border="false" title="家长列表">
    	<table id="grid"></table>
	</div>
	<shiro:hasPermission name="parent-list">
	<form id="searchForm">
		<div id="toolbar" style="padding:2px 5px;">
        	<table>
				<tr>
					...
					<th>家长姓名:</th>
					<td><input id="name" name="name" placeholder="请输入家长姓名" style = "width:150px;"/></td>
					<th>手机:</th>
